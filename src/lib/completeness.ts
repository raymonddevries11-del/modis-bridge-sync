...
export function calculateCompleteness(product: any): CompletenessResult {
  const checks = [
    ...
    { label: "Beschrijving", passed: !!product.webshop_text?.trim(), weight: 15 },
    { label: "Meta titel", passed: !!product.meta_title?.trim(), weight: 5 },
    { label: "Meta description", passed: !!product.meta_description?.trim(), weight: 5 },
